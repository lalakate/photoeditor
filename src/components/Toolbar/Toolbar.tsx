...
import { applyFilter, resetFilters } from '../../store/slices/editorSlice';
import Curves from '../Options/Curves';
import HSL from '../Options/HSL';
import RangeSlider from '../Options/RangeSlider';
...
const Toolbar: React.FC<ToolbarProps> = ({ canvas, image }) => {
