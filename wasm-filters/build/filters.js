...
/** not-@type {!BigUint64Array} */
  ...
  ${functionBody}
    ...
    var _processImageData = (Module['_processImageData'] =
      makeInvalidEarlyAccess('_processImageData'));
    var _createBuffer = (Module['_createBuffer'] =
      makeInvalidEarlyAccess('_createBuffer'));
    var _deleteBuffer = (Module['_deleteBuffer'] =
      makeInvalidEarlyAccess('_deleteBuffer'));
    var _processImageDataWithCurves = (Module['_processImageDataWithCurves'] =
      makeInvalidEarlyAccess('_processImageDataWithCurves'));
    ...
    function assignWasmExports(wasmExports) {
      ...
      Module['_processImageData'] = _processImageData = createExportWrapper(
        'processImageData',
        5
      );
      Module['_createBuffer'] = _createBuffer = createExportWrapper(
        'createBuffer',
        1
      );
      Module['_deleteBuffer'] = _deleteBuffer = createExportWrapper(
        'deleteBuffer',
        1
      );
      Module['_processImageDataWithCurves'] = _processImageDataWithCurves =
        createExportWrapper('processImageDataWithCurves', 4);
